      ...
      <h3>Edit Book Details</h3>
       <form action="EditBooksServlet" method="post">
           <div class="form-group">
             <label>Book ID</label>
             <input class="form-control" name="bkid" value="${edit_books.id }" required>
           </div>
<div class="form-group">
  <label>Book Name</label>
  <input class="form-control" name="bkname" value="${edit_books.bookName }" required>
</div>
<div class="form-group">
  <label>Description</label>
  <input class="form-control" name="bkdes" value="${edit_books.BookDesc}" required>
</div>
<div class="form-group">
